...
class ParaSuit:
    ...
    def sample(self, elapsed, n_total, cov_iter, parameter_values, output_dir, iteration):
        ...
        if (len(self.setD.select_list) > 0):
            parameter_values = self.setD.removing(len(cov_iter), parameter_values, iteration + 1, output_dir)
    ...
    def default_filtering(self, cov_iter, parameter_values, i, output_dir):
        parameter_values = self.setD.removing(len(cov_iter), parameter_values, i + 1, output_dir)

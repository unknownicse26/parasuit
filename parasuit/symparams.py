...
class SymParams:
    ...
    def collectSymArg(self, parameter_values):
        size_list = []
        num = rd.randint(1, 7)
    ...
    def updateSymArg(self, parameter_values, covs):
        size_list = []
    ...
    def collectSymFile(self, parameter_values):
    ...
    def updateSymFile(self, parameter_values, covs):
